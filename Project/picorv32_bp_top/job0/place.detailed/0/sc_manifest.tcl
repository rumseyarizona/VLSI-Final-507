...
dict set sc_cfg "arg" "step" "place.detailed"
...
dict set sc_cfg "record" "inputnode" [list [list "place.repair_design" "0"]]
...
dict set sc_cfg "record" "starttime" "2026-05-08 18:56:03.795408"
...
dict set sc_cfg "tool" "openroad" "task" "detailed_placement" "exe" "openroad"
dict set sc_cfg "tool" "openroad" "task" "detailed_placement" "format" "tcl"
dict set sc_cfg "tool" "openroad" "task" "detailed_placement" "input" [list "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/place.detailed/0/inputs/picorv32_bp_top.sdc" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/place.detailed/0/inputs/picorv32_bp_top.odb.gz"]
...
dict set sc_cfg "tool" "openroad" "task" "detailed_placement" "threads" 20
...
dict set sc_cfg "tool" "openroad" "task" "detailed_placement" "var" "global_connect_fileset" [list [list "sky130hd" "openroad.globalconnect"]]
...
dict set sc_cfg "tool" "openroad" "task" "detailed_placement" "var" "power_corner" "typical"
dict set sc_cfg "tool" "openroad" "task" "detailed_placement" "var" "reports" [list "power_density" "fmax" "placement_density" "power" "drv_violations" "routing_congestion" "module_view" "optimization_placement" "unconstrained" "setup"]
dict set sc_cfg "tool" "openroad" "task" "detailed_placement" "var" "rsz_parasitics" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/place.detailed/0/inputs/sc_parasitics.tcl"
...
dict set sc_cfg "tool" "openroad" "task" "detailed_placement" "version" [list ">=24Q3-2011"]
dict set sc_cfg "tool" "openroad" "task" "detailed_placement" "vswitch" [list "-version"]
...
set sc_task "detailed_placement"
