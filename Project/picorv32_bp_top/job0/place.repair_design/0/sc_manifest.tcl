...
dict set sc_cfg "arg" "step" "place.repair_design"
...
dict set sc_cfg "record" "inputnode" [list [list "place.global" "0"]]
...
dict set sc_cfg "record" "starttime" "2026-05-08 18:55:30.507489"
...
dict set sc_cfg "tool" "openroad" "task" "repair_design" "exe" "openroad"
dict set sc_cfg "tool" "openroad" "task" "repair_design" "format" "tcl"
dict set sc_cfg "tool" "openroad" "task" "repair_design" "input" [list "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/place.repair_design/0/inputs/picorv32_bp_top.sdc" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/place.repair_design/0/inputs/picorv32_bp_top.odb.gz"]
...
dict set sc_cfg "tool" "openroad" "task" "repair_design" "threads" 20
dict set sc_cfg "tool" "openroad" "task" "repair_design" "var" "debug_level" [list ]
dict set sc_cfg "tool" "openroad" "task" "repair_design" "var" "global_connect_fileset" [list [list "sky130hd" "openroad.globalconnect"]]
...
dict set sc_cfg "tool" "openroad" "task" "repair_design" "var" "power_corner" "typical"
dict set sc_cfg "tool" "openroad" "task" "repair_design" "var" "reports" [list "power_density" "fmax" "report_buffers" "placement_density" "power" "drv_violations" "routing_congestion" "module_view" "optimization_placement" "unconstrained" "setup"]
...
dict set sc_cfg "tool" "openroad" "task" "repair_design" "var" "rsz_parasitics" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/place.repair_design/0/inputs/sc_parasitics.tcl"
...
dict set sc_cfg "tool" "openroad" "task" "repair_design" "version" [list ">=24Q3-2011"]
dict set sc_cfg "tool" "openroad" "task" "repair_design" "vswitch" [list "-version"]
