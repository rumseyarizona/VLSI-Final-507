...
dict set sc_cfg "arg" "step" "synthesis"
...
dict set sc_cfg "record" "inputnode" [list [list "elaborate" "0"]]
...
dict set sc_cfg "record" "starttime" "2026-05-08 18:52:28.403179"
dict set sc_cfg "record" "status" "running"
dict set sc_cfg "record" "toolargs" {}
dict set sc_cfg "record" "toolexitcode" {}
dict set sc_cfg "record" "toolpath" "/home/arthur/.local/bin/yosys"
dict set sc_cfg "record" "toolversion" "0.63"
...
dict set sc_cfg "tool" "yosys" "task" "syn_asic" "exe" "yosys"
dict set sc_cfg "tool" "yosys" "task" "syn_asic" "format" "tcl"
dict set sc_cfg "tool" "yosys" "task" "syn_asic" "input" [list "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/synthesis/0/inputs/picorv32_bp_top.v"]
...
dict set sc_cfg "tool" "yosys" "task" "syn_asic" "refdir" [list "/home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/yosys/scripts"]
...
dict set sc_cfg "tool" "yosys" "task" "syn_asic" "var" "abc_constraint_driver" "sky130_fd_sc_hd__buf_4"
dict set sc_cfg "tool" "yosys" "task" "syn_asic" "var" "abc_constraint_file" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/synthesis/0/inputs/sc_abc.constraints"
...
dict set sc_cfg "tool" "yosys" "task" "syn_asic" "var" "synthesis_corner" [list "slow" "generic"]
dict set sc_cfg "tool" "yosys" "task" "syn_asic" "var" "synthesis_libraries" [list "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/synthesis/0/inputs/sc_sky130hd_sky130_fd_sc_hd__ss_n40C_1v40.lib"]
...
dict set sc_cfg "tool" "yosys" "task" "syn_asic" "version" [list ">=0.48"]
dict set sc_cfg "tool" "yosys" "task" "syn_asic" "vswitch" [list "--version"]
...
set sc_tool "yosys"
set sc_task "syn_asic"
set sc_topmodule "picorv32_bp_top"
set sc_designlib "picorv32_bp_top"
set sc_refdir [list "/home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/yosys/scripts"]
