...
dict set sc_cfg "arg" "step" "cts.repair_timing"
...
dict set sc_cfg "record" "inputnode" [list [list "cts.clock_tree_synthesis" "0"]]
...
dict set sc_cfg "record" "starttime" "2026-05-08 18:56:56.458914"
...
dict set sc_cfg "tool" "openroad" "task" "repair_timing" "exe" "openroad"
dict set sc_cfg "tool" "openroad" "task" "repair_timing" "format" "tcl"
dict set sc_cfg "tool" "openroad" "task" "repair_timing" "input" [list "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/cts.repair_timing/0/inputs/picorv32_bp_top.sdc" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/cts.repair_timing/0/inputs/picorv32_bp_top.odb.gz"]
...
dict set sc_cfg "tool" "openroad" "task" "repair_timing" "threads" 20
...
dict set sc_cfg "tool" "openroad" "task" "repair_timing" "var" "global_connect_fileset" [list [list "sky130hd" "openroad.globalconnect"]]
...
dict set sc_cfg "tool" "openroad" "task" "repair_timing" "var" "power_corner" "typical"
dict set sc_cfg "tool" "openroad" "task" "repair_timing" "var" "reports" [list "hold" "power_density" "fmax" "clock_skew" "report_buffers" "placement_density" "power" "clock_placement" "drv_violations" "routing_congestion" "module_view" "optimization_placement" "unconstrained" "clock_trees" "setup"]
...
dict set sc_cfg "tool" "openroad" "task" "repair_timing" "var" "rsz_parasitics" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/cts.repair_timing/0/inputs/sc_parasitics.tcl"
...
dict set sc_cfg "tool" "openroad" "task" "repair_timing" "version" [list ">=24Q3-2011"]
dict set sc_cfg "tool" "openroad" "task" "repair_timing" "vswitch" [list "-version"]
