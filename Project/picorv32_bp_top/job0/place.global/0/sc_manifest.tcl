...
dict set sc_cfg "arg" "step" "place.global"
...
dict set sc_cfg "record" "inputnode" [list [list "floorplan.pin_placement" "0"]]
...
dict set sc_cfg "record" "starttime" "2026-05-08 18:54:01.226248"
...
dict set sc_cfg "tool" "openroad" "task" "global_placement" "exe" "openroad"
dict set sc_cfg "tool" "openroad" "task" "global_placement" "format" "tcl"
dict set sc_cfg "tool" "openroad" "task" "global_placement" "input" [list "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/place.global/0/inputs/picorv32_bp_top.sdc" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/place.global/0/inputs/picorv32_bp_top.odb.gz"]
...
dict set sc_cfg "tool" "openroad" "task" "global_placement" "threads" 20
...
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "global_connect_fileset" [list [list "sky130hd" "openroad.globalconnect"]]
...
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "grt_clock_max_layer" "met5"
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "grt_clock_min_layer" "met1"
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "grt_macro_extension" 0
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "grt_signal_max_layer" "met5"
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "grt_signal_min_layer" "met1"
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "load_grt_setup" true
...
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "pin_layer_horizontal" [list "met3"]
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "pin_layer_vertical" [list "met2"]
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "place_density" 0.5
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "power_corner" "typical"
...
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "reports" [list "power_density" "fmax" "placement_density" "power" "routing_congestion" "module_view" "setup" "unconstrained" "report_buffers"]
dict set sc_cfg "tool" "openroad" "task" "global_placement" "var" "rsz_parasitics" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/place.global/0/inputs/sc_parasitics.tcl"
...
dict set sc_cfg "tool" "openroad" "task" "global_placement" "version" [list ">=24Q3-2011"]
dict set sc_cfg "tool" "openroad" "task" "global_placement" "vswitch" [list "-version"]
