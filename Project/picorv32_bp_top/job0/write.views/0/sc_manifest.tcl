...
dict set sc_cfg "constraint" "area" "corearea" [list [list 10 10] [list 1190 1190]]
dict set sc_cfg "constraint" "area" "coremargin" 1
dict set sc_cfg "constraint" "area" "density" 20
dict set sc_cfg "constraint" "area" "diearea" [list [list 0 0] [list 1200 1200]]
...
dict set sc_cfg "library" "picorv32_bp_top" "dataroot" "local" "path" "/home/arthur/ECE507/project"
dict set sc_cfg "library" "picorv32_bp_top" "dataroot" "local" "tag" {}
dict set sc_cfg "library" "picorv32_bp_top" "deps" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "fileset" "rtl" "define" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "fileset" "rtl" "depfileset" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "fileset" "rtl" "file" "verilog" [list "/home/arthur/ECE507/project/picorv32_bp_top.v" "/home/arthur/ECE507/project/picorv32.v" "/home/arthur/ECE507/project/neural_bht.v" "/home/arthur/ECE507/project/sky130_sram_2k.bb.v"]
dict set sc_cfg "library" "picorv32_bp_top" "fileset" "rtl" "idir" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "fileset" "rtl" "lib" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "fileset" "rtl" "libdir" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "fileset" "rtl" "topmodule" "picorv32_bp_top"
dict set sc_cfg "library" "picorv32_bp_top" "fileset" "rtl" "undefine" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "package" "description" {}
dict set sc_cfg "library" "picorv32_bp_top" "package" "doc" "datasheet" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "package" "doc" "quickstart" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "package" "doc" "reference" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "package" "doc" "releasenotes" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "package" "doc" "signoff" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "package" "doc" "testplan" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "package" "doc" "tutorial" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "package" "doc" "userguide" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "package" "license" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "package" "licensefile" [list ]
dict set sc_cfg "library" "picorv32_bp_top" "package" "vendor" {}
dict set sc_cfg "library" "picorv32_bp_top" "package" "version" {}
...
dict set sc_cfg "library" "sky130_sram_2k" "fileset" "models.physical" "file" "gds" [list "/home/arthur/ECE507/project/sky130_sram_2kbyte_1rw1r_32x512_8.gds"]
dict set sc_cfg "library" "sky130_sram_2k" "fileset" "models.physical" "file" "lef" [list "/home/arthur/ECE507/project/sky130_sram_2kbyte_1rw1r_32x512_8.lef"]
...
dict set sc_cfg "library" "sky130_sram_2k" "fileset" "rtl" "file" "verilog" [list "/home/arthur/ECE507/project/sky130_sram_2k.bb.v"]
...
dict set sc_cfg "option" "builddir" "/home/arthur/ECE507/project/build"
...
dict set sc_cfg "option" "design" "picorv32_bp_top"
dict set sc_cfg "option" "fileset" [list "rtl"]
...
dict set sc_cfg "record" "starttime" "2026-05-08 19:06:29.177303"
...
dict set sc_cfg "tool" "openroad" "task" "write_data" "input" [list "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/write.views/0/inputs/picorv32_bp_top.sdc" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/write.views/0/inputs/picorv32_bp_top.odb.gz"]
...
dict set sc_cfg "tool" "openroad" "task" "write_data" "var" "reports" [list "hold" "power_density" "fmax" "clock_skew" "ir_drop" "placement_density" "power" "clock_placement" "drv_violations" "routing_congestion" "optimization_placement" "unconstrained" "clock_trees" "setup"]
dict set sc_cfg "tool" "openroad" "task" "write_data" "var" "rsz_parasitics" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/write.views/0/inputs/sc_parasitics.tcl"
...
set sc_topmodule "picorv32_bp_top"
set sc_designlib "picorv32_bp_top"
