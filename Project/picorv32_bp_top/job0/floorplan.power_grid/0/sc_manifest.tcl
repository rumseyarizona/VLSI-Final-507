...
dict set sc_cfg "arg" "step" "floorplan.power_grid"
...
dict set sc_cfg "record" "inputnode" [list [list "floorplan.tapcell" "0"]]
...
dict set sc_cfg "record" "starttime" "2026-05-08 18:53:08.384184"
...
dict set sc_cfg "tool" "openroad" "task" "power_grid" "exe" "openroad"
dict set sc_cfg "tool" "openroad" "task" "power_grid" "format" "tcl"
dict set sc_cfg "tool" "openroad" "task" "power_grid" "input" [list "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/floorplan.power_grid/0/inputs/picorv32_bp_top.sdc" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/floorplan.power_grid/0/inputs/picorv32_bp_top.odb.gz"]
...
dict set sc_cfg "tool" "openroad" "task" "power_grid" "threads" 20
...
dict set sc_cfg "tool" "openroad" "task" "power_grid" "var" "global_connect_fileset" [list [list "sky130hd" "openroad.globalconnect"]]
...
dict set sc_cfg "tool" "openroad" "task" "power_grid" "var" "pdn_fileset" [list [list "sky130hd" "openroad.powergrid"]]
dict set sc_cfg "tool" "openroad" "task" "power_grid" "var" "power_corner" "typical"
...
dict set sc_cfg "tool" "openroad" "task" "power_grid" "var" "rsz_parasitics" "/home/arthur/ECE507/project/build/picorv32_bp_top/job0/floorplan.power_grid/0/inputs/sc_parasitics.tcl"
...
dict set sc_cfg "tool" "openroad" "task" "power_grid" "version" [list ">=24Q3-2011"]
dict set sc_cfg "tool" "openroad" "task" "power_grid" "vswitch" [list "-version"]
