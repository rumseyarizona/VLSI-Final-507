...
CD_WORK="/home/arthur/ECE507/SRAM/build/picorv32_top/job0/floorplan.macro_placement/0"
PRINT=""
CMDPREFIX=""
CMDARGS=""
SKIPEXPORT=0
...
case $PRINT in
    ...
    "directory")
        ...
        ;;
    "command")
        echo "openroad /home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/openroad/scripts/apr/sc_macro_placement.tcl -no_init -metrics reports/metrics.json -exit"
        exit 0
        ;;
esac
...
python3 -m siliconcompiler.scheduler.run_node \
    -cfg "inputs/picorv32_top.pkg.json" \
    -builddir "${PWD}/../../../../" \
    -step "floorplan.macro_placement" \
    -index "0" \
    -cwd "$PWD" \
    -replay
else
...
$CMDPREFIX \
openroad \
  /home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/openroad/scripts/apr/sc_macro_placement.tcl \
  -no_init \
