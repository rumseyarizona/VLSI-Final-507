...
CD_WORK="/home/arthur/ECE507/SRAM/build/picorv32_top/job0/write.gds/0"
PRINT=""
CMDPREFIX=""
CMDARGS=""
SKIPEXPORT=0
...
case $PRINT in
    ...
    "directory")
        ...
        ;;
    "command")
        echo "klayout -z -nc -rx -r /home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/klayout/scripts/klayout_export.py -rd SC_KLAYOUT_ROOT=/home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/klayout/scripts -rd SC_TOOLS_ROOT=/home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools -rd SC_ROOT=/home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler"
        exit 0
        ;;
esac
...
klayout \
  ...
  -rx \
  -r \
  /home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/klayout/scripts/klayout_export.py \
  -rd SC_KLAYOUT_ROOT=/home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/klayout/scripts \
  -rd SC_TOOLS_ROOT=/home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools \
  -rd SC_ROOT=/home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler \
  ${CMDARGS}
fi
