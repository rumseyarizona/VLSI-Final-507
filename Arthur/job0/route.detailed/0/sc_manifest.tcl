...
dict set sc_cfg "arg" "step" "route.detailed"
...
dict set sc_cfg "record" "inputnode" [list [list "route.antenna_repair" "0"]]
...
dict set sc_cfg "record" "starttime" "2026-05-03 20:33:45.291712"
...
dict set sc_cfg "tool" "openroad" "task" "detailed_route" "exe" "openroad"
dict set sc_cfg "tool" "openroad" "task" "detailed_route" "format" "tcl"
dict set sc_cfg "tool" "openroad" "task" "detailed_route" "input" [list "/home/arthur/ECE507/SRAM/build/picorv32_top/job0/route.detailed/0/inputs/picorv32_top.sdc" "/home/arthur/ECE507/SRAM/build/picorv32_top/job0/route.detailed/0/inputs/picorv32_top.odb.gz"]
...
dict set sc_cfg "tool" "openroad" "task" "detailed_route" "threads" 20
...
dict set sc_cfg "tool" "openroad" "task" "detailed_route" "var" "global_connect_fileset" [list [list "sky130hd" "openroad.globalconnect"]]
...
dict set sc_cfg "tool" "openroad" "task" "detailed_route" "var" "power_corner" "typical"
dict set sc_cfg "tool" "openroad" "task" "detailed_route" "var" "reports" [list "unconstrained" "clock_trees" "power_density" "fmax" "power" "clock_placement" "clock_skew" "setup" "optimization_placement" "drv_violations" "routing_congestion" "placement_density" "hold"]
dict set sc_cfg "tool" "openroad" "task" "detailed_route" "var" "rsz_parasitics" "/home/arthur/ECE507/SRAM/build/picorv32_top/job0/route.detailed/0/inputs/sc_parasitics.tcl"
...
dict set sc_cfg "tool" "openroad" "task" "detailed_route" "version" [list ">=24Q3-2011"]
dict set sc_cfg "tool" "openroad" "task" "detailed_route" "vswitch" [list "-version"]
