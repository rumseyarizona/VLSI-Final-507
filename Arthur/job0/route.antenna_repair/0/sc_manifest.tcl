...
dict set sc_cfg "arg" "step" "route.antenna_repair"
...
dict set sc_cfg "record" "inputnode" [list [list "route.global" "0"]]
...
dict set sc_cfg "record" "starttime" "2026-05-03 20:32:42.200450"
...
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "exe" "openroad"
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "format" "tcl"
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "input" [list "/home/arthur/ECE507/SRAM/build/picorv32_top/job0/route.antenna_repair/0/inputs/picorv32_top.sdc" "/home/arthur/ECE507/SRAM/build/picorv32_top/job0/route.antenna_repair/0/inputs/picorv32_top.odb.gz"]
...
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "refdir" [list "/home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/openroad/scripts"]
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "regex" "errors" [list "^\\\[ERROR"]
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "regex" "warnings" [list "^\\\[WARNING|^Warning"]
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "require" [list "tool,openroad,task,antenna_repair,var,dpl_use_decap_fillers" "tool,openroad,task,antenna_repair,var,ant_iterations" "tool,openroad,task,antenna_repair,var,ant_margin" "tool,openroad,task,antenna_repair,var,grt_macro_extension" "tool,openroad,task,antenna_repair,var,grt_signal_min_layer" "tool,openroad,task,antenna_repair,var,grt_clock_min_layer" "tool,openroad,task,antenna_repair,var,grt_signal_max_layer" "tool,openroad,task,antenna_repair,var,grt_clock_max_layer" "tool,openroad,task,antenna_repair,var,grt_allow_congestion" "tool,openroad,task,antenna_repair,var,grt_overflow_iter" "tool,openroad,task,antenna_repair,var,sta_early_timing_derate" "tool,openroad,task,antenna_repair,var,sta_late_timing_derate" "tool,openroad,task,antenna_repair,var,sta_top_n_paths" "tool,openroad,task,antenna_repair,var,sta_define_path_groups" "tool,openroad,task,antenna_repair,var,sta_unique_path_groups_per_clock" "tool,openroad,task,antenna_repair,var,opensta_generic_sdc" "library,sky130hd,asic,cells,tie" "library,sky130hd,asic,cells,filler" "library,sky130hd,asic,cells,tap" "library,sky130hd,asic,cells,endcap" "library,sky130hd,asic,cells,antenna" "tool,openroad,task,antenna_repair,var,ord_enable_images" "tool,openroad,task,antenna_repair,var,ord_heatmap_bins" "tool,openroad,task,antenna_repair,var,load_grt_setup" "tool,openroad,task,antenna_repair,var,load_sdcs" "tool,openroad,task,antenna_repair,var,global_connect_fileset" "library,sky130hd,fileset,openroad.globalconnect,file,tcl" "constraint,timing,scenario,fast,pexcorner" "constraint,timing,scenario,fast,libcorner" "constraint,timing,scenario,fast,check" "constraint,timing,scenario,slow,pexcorner" "constraint,timing,scenario,slow,libcorner" "constraint,timing,scenario,slow,check" "constraint,timing,scenario,typical,pexcorner" "constraint,timing,scenario,typical,libcorner" "constraint,timing,scenario,typical,check" "library,sky130hd,asic,libcornerfileset,fast,nldm" "library,sky130hd,fileset,models.timing.fast.nldm,file,liberty" "library,sky130hd,asic,libcornerfileset,typical,nldm" "library,sky130hd,fileset,models.timing.typical.nldm,file,liberty" "library,sky130hd,asic,libcornerfileset,slow,nldm" "library,sky130hd,fileset,models.timing.slow.nldm,file,liberty" "tool,openroad,task,antenna_repair,var,power_corner" "tool,openroad,task,antenna_repair,var,ant_check" "tool,openroad,task,antenna_repair,var,ant_repair"]
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "script" [list "/home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/openroad/scripts/apr/sc_antenna_repair.tcl"]
...
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "threads" 20
...
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "var" "global_connect_fileset" [list [list "sky130hd" "openroad.globalconnect"]]
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "var" "grt_allow_congestion" false
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "var" "grt_clock_max_layer" "met5"
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "var" "grt_clock_min_layer" "met1"
...
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "var" "grt_signal_max_layer" "met5"
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "var" "grt_signal_min_layer" "met1"
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "var" "load_grt_setup" true
...
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "var" "power_corner" "typical"
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "var" "reports" [list "unconstrained" "clock_trees" "power_density" "fmax" "module_view" "power" "clock_placement" "clock_skew" "setup" "optimization_placement" "drv_violations" "routing_congestion" "placement_density" "hold"]
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "var" "rsz_parasitics" "/home/arthur/ECE507/SRAM/build/picorv32_top/job0/route.antenna_repair/0/inputs/sc_parasitics.tcl"
...
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "version" [list ">=24Q3-2011"]
dict set sc_cfg "tool" "openroad" "task" "antenna_repair" "vswitch" [list "-version"]
