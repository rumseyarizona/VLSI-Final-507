...
CD_WORK="/home/arthur/ECE507/SRAM/build/picorv32_top/job0/place.repair_design/0"
PRINT=""
CMDPREFIX=""
CMDARGS=""
SKIPEXPORT=0
...
case $PRINT in
    ...
    "directory")
        ...
        ;;
    "command")
        echo "openroad /home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/openroad/scripts/apr/sc_repair_design.tcl -no_init -metrics reports/metrics.json -exit"
        exit 0
        ;;
esac
...
$CMDPREFIX \
openroad \
  /home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/openroad/scripts/apr/sc_repair_design.tcl \
  -no_init \
