...
CD_WORK="/home/arthur/ECE507/SRAM/build/picorv32_top/job0/synthesis/0"
PRINT=""
CMDPREFIX=""
CMDARGS=""
SKIPEXPORT=0
...
case $PRINT in
    ...
    "directory")
        ...
        ;;
    "command")
        echo "yosys -c /home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/yosys/scripts/sc_synth_asic.tcl"
        exit 0
        ;;
esac
...
yosys \
  -c \
  /home/arthur/ECE507/venv/lib/python3.12/site-packages/siliconcompiler/tools/yosys/scripts/sc_synth_asic.tcl \
  ${CMDARGS}
fi
