...
import freechips.rocketchip.rocket.{BHTTypeKey, BHTType}
...
class MyRocketStaticNotTakenBPConfig extends Config(
  new freechips.rocketchip.rocket.WithStaticNotTakenBP ++
  new freechips.rocketchip.rocket.WithNBigCores(1) ++
  new chipyard.config.AbstractConfig
)

class MyRocketStaticTakenBPConfig extends Config(
  new freechips.rocketchip.rocket.WithStaticTakenBP ++
  new freechips.rocketchip.rocket.WithNBigCores(1) ++
  new chipyard.config.AbstractConfig
)

class MyRocketBimodalBPConfig extends Config(
  new freechips.rocketchip.rocket.WithBimodalBP ++
  new freechips.rocketchip.rocket.WithNBigCores(1) ++
  new chipyard.config.AbstractConfig
)

class MyRocketGShareBPConfig extends Config(
  new freechips.rocketchip.rocket.WithGShareBP ++
  new freechips.rocketchip.rocket.WithNBigCores(1) ++
  new chipyard.config.AbstractConfig
)

class MyRocketNoBPConfig extends Config(
  new freechips.rocketchip.rocket.WithNoBtb ++   
  new freechips.rocketchip.rocket.WithNBigCores(1) ++
  new chipyard.config.AbstractConfig
)

class MyRocketNeuralBPConfig extends Config(
  new freechips.rocketchip.rocket.WithNeuralBP ++
  new freechips.rocketchip.rocket.WithNBigCores(1) ++
  new chipyard.config.AbstractConfig
)