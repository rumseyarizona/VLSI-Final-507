...
class WithStaticNotTakenBP extends Config((site, here, up) => {
  case BHTTypeKey => BHTType.staticNotTaken
})

// static taken predictor
class WithStaticTakenBP extends Config((site, here, up) => {
  case BHTTypeKey => BHTType.staticTaken
})

// bimodal predictor
class WithBimodalBP extends Config((site, here, up) => {
  case BHTTypeKey => BHTType.bimodal
})

// GShare predictor 
class WithGShareBP extends Config((site, here, up) => {
  case BHTTypeKey => BHTType.gshare
})

// perceptron predictor
class WithNeuralBP extends Config((site, here, up) => {
  case BHTTypeKey => BHTType.neural
})
